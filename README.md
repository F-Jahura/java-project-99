...
[![Java CI](https://github.com/F-Jahura/java-project-99/actions/workflows/main.yml/badge.svg)](https://github.com/F-Jahura/java-project-99/actions/workflows/main.yml)
...
**Демо:** [https://java-project-99-dolt.onrender.com](https://java-project-99-dolt.onrender.com)  
> ⚠️ *Бесплатный хостинг на Render: первый запуск может занять 30–40 секунд.*
...
**CRUD задачи:**
      ...
      - Указать статус задач
      - Структурировать задачи метками
